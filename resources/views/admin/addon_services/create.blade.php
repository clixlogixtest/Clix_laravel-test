...
@section('title') {{ __('Add Addon Service') }} @endsection
    ...
    <div class="row mb-2">
		...
		<div class="col-sm-6">
			<ol class="breadcrumb float-sm-right">
				...
				<li class="breadcrumb-item active">{{ __('Add Addon Service') }}</li>
			</ol>
		</div>
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
			...
			@include('includes.message')
  			...
  			<div class="card card-default">
		      	<div class="card-header">
		        	<h3 class="card-title">{{ __('Add Addon Service') }}</h3>
		      	...
		      	<form action="{{ route('admin.addon_services.store') }}" method="POST" enctype="multipart/form-data">
			    	@csrf
			      	<div class="card-body">
						<div class="row">
							<div class="col-md-12">
