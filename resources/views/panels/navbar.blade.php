  ...
  <nav
    ...
    <div class="nav-wrapper">
        ...
        <li>
          <a class="waves-effect waves-block waves-light profile-button" href="javascript:void(0);"
            ...
            <span class="avatar-status avatar-online">
              <img src="{{asset('images/avatar/user-profile-placeholder-image-png.jpg')}}" alt="avatar"><i></i>
            </span>
          </a>
        </li>
        <!-- <li>
      ...
      <ul class="dropdown-content" id="profile-dropdown">
        ...
        <li>
          <a class="grey-text text-darken-1" href="{{ route('organisations.organisationProfile', auth()->user()->organisation_id) }}">
        ...
        @endif
        <li>
          <a class="grey-text text-darken-1" href="{{ route('users.userProfile', auth()->user()->id) }}">
            <i class="material-icons">person_outline</i>
            Profile
          </a>
        </li> 
        <li class="divider"></li>
        <li>
          <a class="grey-text text-darken-1" href="{{ route('users.changePassword', auth()->user()->id) }}">
            <i class="material-icons">person_outline</i>
            Change Password
          </a>
        </li> 
        <li class="divider"></li>
        <li>
          <!-- <form action="{{ route('admin.logout') }}" method="post" class="login-form">
            {{ csrf_field() }} -->
             <a href="{{ route('admin.logout') }}" class="grey-text text-darken-1"><i class="material-icons">keyboard_tab</i>
            Logout</a>
          <!-- </form> -->
        </li>
      </ul>
